 ...
 * @author Ignacio
 */
public class VentanaFactPrimos extends javax.swing.JFrame {

    /**
     * Creates new form VentanaFactPrimos
     */
    public VentanaFactPrimos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Programa que descompone en factores primos un número entero introducido por el usuario");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaFactPrimos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaFactPrimos().setVisible(true);
            }
        });
    }
